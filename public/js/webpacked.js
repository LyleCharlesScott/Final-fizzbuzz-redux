...
/***/ function(module, exports, __webpack_require__) {
	...
	var write = function(instance, destination, firstNumber, secondNumber) {
	  var fbOutputArray = instance.output();
	  var fbOutputTitle = "Low number: " + firstNumber + " High number: " + secondNumber;
	  var fbOutputString = ""; 
	...
	document.getElementById("submit").addEventListener("click", function(e) {
	  e.preventDefault();
	  var firstNumber = parseInt(document.getElementById('number-one').value);
	  var secondNumber = parseInt(document.getElementById('number-two').value);
	  fbFizzbuzz.input(firstNumber, secondNumber);
	  document.getElementById('number-one').value = "";
	  document.getElementById('number-two').value = "";
	  write(fbfizzbuzz, document.getElementById("result-box"), firstNumber, secondNumber);
	...
	document.getElementById("submitb").addEventListener("click", function(e) {
	  ...
	  var firstNumber = parseInt(document.getElementById('number-one').value);
	  var secondNumber = parseInt(document.getElementById('number-two').value);
	  fbBleepBlorp.input(firstNumber, secondNumber);
	  document.getElementById('number-oneb').value = "";
	  document.getElementById('number-twob').value = "";
	  write(fbBleepBlorp, document.getElementById("result-boxb"), firstNumber, secondNumber);
